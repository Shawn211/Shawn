...
def login(player):
    lg0=requests.get(player,headers=headers5,proxies=proxies).content
    ...
    lg1=requests.get(url0,headers=headers5,proxies=proxies).content
    ...
    if re.search('欢迎回家',lg1):
        ...
        lg2=requests.get(url1,headers=headers5,proxies=proxies).content
        ...
        html=requests.get(gameurl,headers=headers5,proxies=proxies).content
        html=etn(html)
